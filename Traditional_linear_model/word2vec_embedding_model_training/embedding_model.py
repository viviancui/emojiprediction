...
mat.dump("tfidf_matrix_embedding1.dat")
...
test_df_gold.to_csv('w2v_gold.csv',index=False)
test_df_pred.to_csv('w2v_pred.csv',index=False)

test_df_new = test_df[['predicted_str','target']]
test_df_new.to_csv('w2v_result.csv',index=False)
